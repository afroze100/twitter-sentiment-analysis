...
########################################## TRAINING AND TEST DATA SEPARATION
    ...
    selector = 8               ## can be any itegerer from 0-9, each value returns with a different test/training sample for 10-fold cross validation
...
################### Objectivity Classification of Training Data
    ...
    for index in range(0,len(list_tweets_training)):
        ...
        score_obj = feat_obj[0]*feat_obj[1]*feat_obj[2]*feat_obj[3]*feat_obj[4]*feat_obj[5]*(float(4543)/8963)
        score_subj = feat_subj[0]*feat_subj[1]*feat_subj[2]*feat_subj[3]*feat_subj[4]*feat_subj[5]*(float(4420)/8963)
...
################### Subjectivity Classification of Training Data
    ...
    for index in range(0,len(list_tweets_training)):
        ...
        score_pos = feat_pos[0]*feat_pos[1]*feat_pos[2]*feat_pos[3]*feat_pos[4]*feat_pos[5]
        score_neg = feat_neg[0]*feat_neg[1]*feat_neg[2]*feat_neg[3]*feat_neg[4]*feat_neg[5]
