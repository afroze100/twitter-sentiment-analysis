...
############################
    ...
    for i in range(0,len(training_labels)):
        if training_labels[i]=="0":
            words_obj_train+=len(training_tweets[i])
        else:
            words_subj_train+=len(training_tweets[i])
...
############################
    ...
    for i in range(0,len(test_tweets)):       ## list_score_sum
        tweet=test_tweets[i]
        score=0
        for word in tweet:
...
#############################
    ...
    for index in range(0,len(test_tweets)):
        final_list.append([str(list_score_sum[index]),str(list_score_bayes[index]),str(list_score_lexicon[index]),test_labels[index]])

    for ind in range(0,len(test_tweets)):
    ...
    return final_list,test_tweets,test_labels
